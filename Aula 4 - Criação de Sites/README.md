...
<!--------------- 📍 Introdução -------------->
## 📍 Introdução
> Este Projeto foi feito durante a 4° aula da **Jornada Python Hashtag**, onde criamos uma aplicação web de um chat utilizando a biblioteca Flet. Esse chat consegue simular uma conversação em tempo real onde vários usuários conseguem participar simultaneamente pelo navegador.  
&nbsp;
